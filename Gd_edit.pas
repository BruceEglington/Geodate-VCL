...
type
  TfmEdit = class(TForm)
    ...
    dbeYPrec: TDBEdit;
    dbeYErr: TDBEdit;
    dbcbYErrType: TDBComboBox;
    dbeZRatio: TDBEdit;
    dbeZPrec: TDBEdit;
    dbeR: TDBEdit;
    dbcbRegInclude: TDBCheckBox;
    dbcbPlotInclude: TDBCheckBox;
    lSample: TLabel;
    eRec: TEdit;
    eRecCount: TEdit;
    Label1: TLabel;
    ...
    dbeZErr: TDBEdit;
    dbcbZErrType: TDBComboBox;
    bbErrorsA: TBitBtn;
    lWStr: TLabel;
    dbeWRatio: TDBEdit;
    dbeWPrec: TDBEdit;
    dbeWErr: TDBEdit;
    dbcbWErrType: TDBComboBox;
    lAgeStr: TLabel;
    dbeAgeValue: TDBEdit;
    dbeAge95pcValue: TDBEdit;
    lRhoExtra: TLabel;
    dbeR86: TDBEdit;
    dbeZZ: TDBEdit;
    lZZStr: TLabel;
